...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  // ============================================================
  // HELPER: ADMIN CHAT METADATA SYNC
  // ============================================================
...
//       // Har baar fresh account chooser sheet dikhane ke liye sign out force karein
//       await googleSignIn.signOut();
...
//           String displayName = user.displayName ?? "Customer";
//           String photoUrl = user.photoURL ?? "";
...
//             });
//           } else {
//             // Document exist karta hai toh values fetch kar lein
//             displayName = userDoc.data()?['name'] ?? displayName;
//             photoUrl = userDoc.data()?['photoUrl'] ?? photoUrl;
//           }

//           // Admin Chat node mein User profile sync karein taake admin chat screen par name aur photo show ho
...
//         // Email signup par bhi Admin Chat metadata document initialize kar rahe hain
//         await FirebaseFirestore.instance.collection("chats").doc(user.uid).set({
//           "userId": user.uid,
//           "userName": name,
//           "userPhoto": "",
