  ...
  Future<void> loginUser() async {
    ...
    try {
      ...
      if (user != null) {
        ...
        String displayName = userDoc.exists ? (userDoc.data()?['name'] ?? user.displayName ?? "") : (user.displayName ?? "");
        String photoUrl = userDoc.exists ? (userDoc.data()?['photoUrl'] ?? user.photoURL ?? "") : (user.photoURL ?? "");
...
//     await FirebaseFirestore.instance.collection("chats").doc(uid).set({
//       "userId": uid,
//       "userName": name.isNotEmpty ? name : "Customer",
//       "userPhoto": photoUrl,
//       "userEmail": email,
//       "createdAt": FieldValue.serverTimestamp(),
//     }, SetOptions(merge: true));
...
//       // Sign out force karein taake har login par Google Email selection sheet appear ho
//       await googleSignIn.signOut();
...
//         // Admin Chat sync for Email Login
//         await _syncUserToAdminChat(
//           uid: user.uid,
//           name: displayName,
//           photoUrl: photoUrl,
